...
from src.cities.schemas import City, CityCreate
...
@router.post(
    "/",
    response_description="Returns JSON with the ID of the created city.",
)
...
@router.delete(
    "/{city_id}",
    response_description="Returns JSON with the ID of the deleted city.",
)
